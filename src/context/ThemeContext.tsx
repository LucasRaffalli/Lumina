import { AccentColor, ThemeContextType } from '@/utils/lumina';
...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
    ...
    return (
        <ThemeContext.Provider value={{ accentColor: accentColor as AccentColor, toggleTheme, setAccentColor: changeAccentColor, themeMode }}>
            {children}
